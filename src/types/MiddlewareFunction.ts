 ...
 * does anything with them, and returns a {@link Tuple} where the first item is the Message object and the
 ...
 *
 * >**Note:** The command dispatcher will attempt to bind the Command instance to the middleware
 * function when called, so `this` within a middleware function (if it is not an arrow function)
 * will be the Command instance at runtime
 */
