...
export declare class Providers {
     ...
     */
    static PostgresProvider: (url: string, debug?: boolean) => StorageProviderConstructor;
    /**
     * Factory method that returns a StorageProvider class for
     ...
     * @returns {StorageProviderConstructor}
     */
    static MSSQLProvider: (url: string, debug?: boolean) => StorageProviderConstructor;
    /**
     * Factory method that returns a StorageProvider class for
     ...
     * @returns {StorageProviderConstructor}
     */
    static MySQLProvider: (url: string, debug?: boolean) => StorageProviderConstructor;
    /**
     * Factory method that returns a StorageProvider class for
     ...
     * @returns {StorageProviderConstructor}
     */
    static SQLiteProvider: (path: string, debug?: boolean) => StorageProviderConstructor;
    /**
